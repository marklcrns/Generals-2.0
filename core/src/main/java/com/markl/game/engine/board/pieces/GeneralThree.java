...
public class GeneralThree extends Piece {
	 ...
	 */
	public GeneralThree(int pieceId, final Board board, final Player owner, final Alliance alliance) {
	 ...
	 * this Piece.
	 */
	public GeneralThree(int pieceId, final Board board, final Player owner,
