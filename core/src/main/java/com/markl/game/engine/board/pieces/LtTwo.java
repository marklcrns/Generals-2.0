...
public class LtTwo extends Piece {
	...
	private final int powerLevel = BoardUtils.LT_TWO_POW;                // Power level of the piece to compare ranks
	 ...
	 */
	public LtTwo(int pieceId, final Board board, final Player owner, final Alliance alliance) {
	 ...
	 * this Piece.
	 */
	public LtTwo(int pieceId, final Board board, final Player owner,
