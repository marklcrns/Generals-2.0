...
public class Tile {
    ...
    private final int tileId;         // Tile unique index or ID number. From 0 to 71
    private final Alliance territory; // Tile territorial Alliance. 0 - 35 black and 36 - 71 white territory.
